...
if (!function_exists('get_dashboard_module_groups')) {
    ...
    function get_dashboard_module_groups() {
        return [
            ...
            'clients' => ['clients', 'clients_list', 'clients_add', 'clients_edit', 'clients_delete', 'clients_import', 'clients_export', 'clients_urls'],
            'recruitment' => [
    ...
    function get_controller_module_access_map() {
        return [
            ...
            'clients' => [
                ...
                'clients_view', 'clients_export', 'clients_import', 'clients_urls',
            ],
