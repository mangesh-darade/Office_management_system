...
<div class="container py-4">
  ...
  <h1 class="h4 mb-3"><?php echo esc_view($assessment->title); ?></h1>
  <?php if (!empty($assessment->description)): ?>
    <p class="text-muted"><?php echo nl2br(esc_view($assessment->description)); ?></p>
  <?php endif; ?>
  ...
  <?php else: ?>
    <?php foreach ($questions as $i => $q): ?>
      <div class="card shadow-sm border-0 mb-3">
        <div class="card-header bg-white py-2 small text-muted">Question <?php echo (int)$i + 1; ?> · <?php echo esc_view(strtoupper($q->question_type)); ?> · <?php echo esc_view(number_format((float)$q->points, 2)); ?> pts</div>
        <div class="card-body">
          <p class="mb-3"><?php echo nl2br(esc_view($q->question_text)); ?></p>
          ...
          <?php else: ?>
            <span class="badge bg-secondary mb-2"><?php echo strtoupper(esc_view($q->coding_language)); ?></span>
