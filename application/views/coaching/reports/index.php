...
<table class="table table-sm card shadow-soft"><thead><tr><th>Coach</th><th>Active clients</th></tr></thead><tbody><?php foreach ($by_coach as $r): ?><tr><td><?php echo htmlspecialchars($r->coach_name); ?></td><td><?php echo (int)$r->client_count; ?></td></tr><?php endforeach; ?></tbody></table>
