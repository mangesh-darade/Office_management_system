...
<div class="card shadow-sm border-0">
  <div class="card-body">
    <form method="post" action="<?php echo $action === 'edit' ? site_url('types/edit/' . (int) $type->id) : site_url('types/create'); ?>">
      <div class="row g-2 oms-form-grid">
        ...
        <div class="col-12">
          ...
          <a class="btn btn-outline-secondary" href="<?php echo site_url('types'); ?>">Cancel</a>
        </div>
      </div>
    </form>
  </div>
