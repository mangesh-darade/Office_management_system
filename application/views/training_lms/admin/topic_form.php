  ...
  <div class="card shadow-sm border-0 mb-3">
    ...
    <div class="card-body">
      <div class="mb-3">
        ...
        <input type="text" name="name" class="form-control" required maxlength="255" value="<?php echo $ed ? esc_view($topic->name) : ''; ?>">
      </div>
      <div class="mb-3">
        <label class="form-label">Description</label>
        <textarea name="description" class="form-control" rows="3"><?php echo $ed ? esc_view($topic->description) : ''; ?></textarea>
      </div>
      <div class="mb-3">
        <label class="form-label">Prerequisites</label>
        <textarea name="prerequisites" class="form-control" rows="2"><?php echo $ed ? esc_view($topic->prerequisites) : ''; ?></textarea>
      </div>
      <div class="mb-3">
        ...
        <select name="prerequisite_topic_id" class="form-select">
          ...
          <?php foreach ($sibling_topics as $st): ?>
            ...
            <option value="<?php echo (int) $st->id; ?>" <?php echo ($ed && isset($topic->prerequisite_topic_id) && (int) $topic->prerequisite_topic_id === (int) $st->id) ? 'selected' : ''; ?>><?php echo esc_view($st->name); ?></option>
          <?php endforeach; ?>
        </select>
        ...
        <div class="col-md-6">
          ...
          <select name="assessment_id" class="form-select" <?php echo $hasAssessments ? '' : 'disabled'; ?>>
            ...
            <?php foreach ($assessments as $a): ?>
              <option value="<?php echo (int) $a->id; ?>" <?php echo ($ed && (int) $topic->assessment_id === (int) $a->id) ? 'selected' : ''; ?>><?php echo esc_view($a->title); ?></option>
            <?php endforeach; ?>
          </select>
  ...
  <div class="card shadow-sm border-0 mb-3">
    ...
    <div class="card-body">
      <div class="mb-2">
        ...
        <input type="text" name="assignment_name" class="form-control" maxlength="255" value="<?php echo ($ed && $assignment) ? esc_view($assignment->name) : ''; ?>" placeholder="e.g. Week 1 reflection">
      </div>
      <div class="mb-3">
        <label class="form-label">Instructions / details</label>
        <textarea name="assignment_details" class="form-control" rows="4" placeholder="What learners should submit"><?php echo ($ed && $assignment) ? esc_view($assignment->details) : ''; ?></textarea>
      </div>
      <div class="mb-0">
