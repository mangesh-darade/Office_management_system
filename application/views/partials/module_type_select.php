...
?>
<select name="<?php echo htmlspecialchars($field_name); ?>" id="<?php echo htmlspecialchars($field_name); ?>" class="<?php echo htmlspecialchars($select_class); ?>"<?php echo $required ? ' required' : ''; ?>>
  <?php if (!$required): ?>
    <option value=""><?php echo htmlspecialchars($placeholder); ?></option>
  <?php endif; ?>
  <?php foreach ($options as $code => $label): ?>
    <option value="<?php echo htmlspecialchars($code); ?>" <?php echo $current === (string) $code ? 'selected' : ''; ?>><?php echo htmlspecialchars($label); ?></option>
  <?php endforeach; ?>
</select>
