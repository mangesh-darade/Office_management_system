...
<?php foreach ($rows as $t): ?><tr><td><?php echo esc_view($t->created_at); ?></td><td><?php echo esc_view($t->rule_name ?: $t->source_event); ?></td><td><?php echo number_format((float)$t->points,0); ?></td><td><?php echo esc_view($t->status); ?></td><td><?php echo esc_view($t->reference_label ?: ''); ?></td></tr><?php endforeach; ?>
