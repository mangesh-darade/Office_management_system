...
<div class="col-md-4">
  <div class="card shadow-soft"><div class="card-body">
    ...
    <select name="coach_id" class="form-select mb-2"><?php foreach ($coaches as $c): ?><option value="<?php echo (int)$c->id; ?>"><?php echo htmlspecialchars($c->name); ?></option><?php endforeach; ?></select>
...
<div class="col-md-8">
  ...
  <?php foreach ($rows as $r): ?><tr><td><?php echo htmlspecialchars($r->coach_name); ?></td><td>₹<?php echo number_format($r->amount,2); ?></td><td><?php echo htmlspecialchars($r->payout_date); ?></td><td><?php echo htmlspecialchars($r->status); ?></td></tr><?php endforeach; ?>
  </tbody></table>
</div>
</div>
