...
<div class="row g-2 oms-form-grid mb-3"><div class="col-md-6"><label class="form-label">Certified on</label><input type="date" name="certified_on" class="form-control"></div><div class="col-md-6"><label class="form-label">Expires on</label><input type="date" name="expires_on" class="form-control"></div></div>
