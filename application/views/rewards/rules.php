...
<?php foreach ($rows as $r): ?><tr><td><code><?php echo esc_view($r->code); ?></code></td><td><?php echo esc_view($r->name); ?></td><td><?php echo esc_view($r->trigger_event); ?></td><td><?php echo number_format((float)$r->points,0); ?></td><td><?php echo $r->is_active?'Yes':'No'; ?></td><td><a class="btn btn-sm btn-outline-secondary" href="<?php echo site_url('rewards/edit-rule/'.$r->id); ?>">Edit</a></td></tr><?php endforeach; ?>
