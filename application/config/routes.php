...
$route['clients/urls'] = 'clients/urls';
$route['clients/urls/create'] = 'clients/url_create';
$route['clients/urls/edit/(:num)'] = 'clients/url_edit/$1';
...
$route['clients/history-attachment/(:num)/(:num)'] = 'clients/history_attachment/$1/$2';
$route['clients/history-attachment/(:num)/(:num)/(:num)'] = 'clients/history_attachment/$1/$2/$3';
...
$route['tasks/ajax-dashboard-create-task'] = 'tasks/ajax_dashboard_create_task';
...
$route['my-works/back-log'] = 'my_works/back_log';
$route['my-works/need-discussion'] = 'my_works/need_discussion';
...
$route['spl/member/(:num)'] = 'spl/member/$1';
$route['spl/evidence/(:num)/download'] = 'spl/evidence_download/$1';
$route['spl/evidence/(:num)/preview'] = 'spl/evidence_preview/$1';
...
$route['reports/defects'] = 'reports_projects/defects';
...
// Business Assessment (static ROI tool ΓÇö client-side only)
...
// Payroll export (no id = all payslips) ΓÇö defined above
// Clients contacts ΓÇö defined above
// Approvals delete ΓÇö defined above
...
$route['releases/import'] = 'releases/import';
...
$route['defects/toggle-active/(:num)'] = 'defects/toggle_active/$1';
$route['defects/export'] = 'defects/export';
$route['defects/import'] = 'defects/import';
