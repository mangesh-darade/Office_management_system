...
<tr><td><?php echo esc_view($r->customer_name ?: '—'); ?></td><td><?php echo (int)$r->rating; ?>/5</td><td><?php echo esc_view($r->project_name ?: '—'); ?></td><td><?php echo esc_view($r->submitter_name); ?></td><td><?php echo esc_view($r->created_at); ?></td></tr>
