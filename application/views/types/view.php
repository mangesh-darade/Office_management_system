...
<div class="d-flex justify-content-between align-items-center mb-3">
  <h1 class="h4 mb-0"><?php echo esc_view($type->name); ?></h1>
...
<div class="card shadow-sm border-0">
  <div class="card-body">
    <dl class="row mb-0">
      ...
      <dd class="col-sm-9"><code><?php echo esc_view($type->code); ?></code></dd>
      <dt class="col-sm-3">Module</dt>
      <dd class="col-sm-9"><?php echo esc_view(isset($modules[$type->module]) ? $modules[$type->module] : $type->module); ?></dd>
      ...
      <dd class="col-sm-9"><?php echo nl2br(esc_view($type->description)); ?></dd>
      <?php endif; ?>
    </dl>
  </div>
</div>
