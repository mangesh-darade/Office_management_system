<?php $this->load->view('partials/header', array('title' => 'Add Client')); ?>

<div class="oms-form-compact">
  <div class="oms-form-page-head">
    <a class="btn btn-outline-secondary btn-sm oms-form-back" href="<?php echo site_url('clients'); ?>">
  ...
  <form method="post" action="" enctype="multipart/form-data" data-validate="true">
    <div class="card shadow-soft oms-form-card">
        ...
        <section class="oms-form-section">
          ...
          <div class="row g-2 oms-form-grid">
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <input type="text" name="phone" id="phone" class="form-control" data-max-length="20" data-pattern="^[0-9+\s\-\(\)]*$">
            </div>
            <div class="col-lg-3 col-md-6">
      ...
      <div class="card-footer oms-form-actions">
        <button type="submit" class="btn btn-primary" id="submitBtn"><i class="bi bi-check-lg me-1"></i>Create Client</button>
        <a class="btn btn-outline-secondary" href="<?php echo site_url('clients'); ?>">Cancel</a>
      </div>
    </div>
  </form>
</div>
