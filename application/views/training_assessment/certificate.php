...
<div class="container py-4">
  ...
  <div class="ta-cert card border-0 shadow-sm mx-auto" style="max-width:640px">
    <div class="card-body p-4 p-md-5 text-center">
      ...
      <h1 class="h3 mb-4"><?php echo esc_view($assessment && !empty($assessment->title) ? $assessment->title : $au->assessment_title); ?></h1>
      <p class="mb-1 text-muted">This certifies that</p>
      <p class="fs-4 fw-semibold mb-3"><?php echo esc_view($displayName); ?></p>
      <p class="text-muted small mb-4">has completed the assessment<?php if ($result && $result->submitted_at): ?> on <?php echo esc_view($result->submitted_at); ?><?php endif; ?>.</p>
      <div class="row g-2 justify-content-center mb-4">
        <div class="col-6 col-md-4">
          <div class="border rounded p-3 bg-light">
            <div class="small text-muted">Score</div>
            <div class="fs-5 fw-bold"><?php echo esc_view(number_format((float) $result->score_percent, 1)); ?>%</div>
          </div>
        </div>
        <div class="col-6 col-md-4">
          <div class="border rounded p-3 bg-light">
      ...
      <p class="small text-muted mb-0">Issued by <?php echo function_exists('get_company_name') ? esc_view(get_company_name()) : 'Office Management System'; ?></p>
    </div>
  </div>
</div>
