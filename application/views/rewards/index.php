...
<div class="row g-3 mb-4">
  ...
  <div class="col-md-4"><div class="card shadow-soft h-100"><div class="card-body text-center"><div class="h3 fw-bold" style="color:<?php echo htmlspecialchars($levelColor); ?>"><?php echo htmlspecialchars($levelName); ?></div><div class="text-muted">Current level</div></div></div></div>
...
<tr><td><?php echo htmlspecialchars($t->created_at); ?></td><td><?php echo htmlspecialchars($t->rule_name ?: $t->source_event); ?></td><td class="<?php echo ((float)$t->points>=0)?'text-success':'text-danger'; ?>"><?php echo ((float)$t->points>=0?'+':'').number_format((float)$t->points,0); ?></td><td><?php echo htmlspecialchars($t->reference_label ?: '—'); ?></td></tr>
