    ...
    <form method="post" action="" enctype="multipart/form-data" class="vstack gap-3" data-validate="true">
      <div class="row g-2 oms-form-grid">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <input type="url" name="website" id="website" class="form-control" placeholder="https://example.com" value="<?php echo esc_view(isset($client->website)?$client->website:''); ?>">
        </div>
        <div class="col-lg-3 col-md-6">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <input type="url" name="demo_url" class="form-control" placeholder="https://demo.example.com" value="<?php echo esc_view(isset($client->demo_url)?$client->demo_url:''); ?>">
        </div>
        <div class="col-lg-3 col-md-6">
          <label class="form-label">POS URL</label>
          <input type="url" name="pos_url" class="form-control" placeholder="https://pos.example.com" value="<?php echo esc_view(isset($client->pos_url)?$client->pos_url:''); ?>">
        </div>
        <div class="col-12">
