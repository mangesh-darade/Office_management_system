...
<div class="filter-section">
  <form method="get" class="filter-form">
    ...
    <div class="form-group">
      ...
      <select name="punctuality" class="form-control" id="punctuality-select" title="Show employees matching selected grace rule">
        <option value="all" <?php echo ($punctuality_filter === 'all') ? 'selected' : ''; ?>>All</option>
              ...
              <td class="text-end">
                <div style="display: flex; gap: 0.25rem; justify-content: flex-end;">
                  <?php 
                    ...
                    if (isset($grace_override) && $grace_override !== null && $grace_override !== '') {
                        $viewParams['grace'] = (int) $grace_override;
                    }
                    if ($punctuality_filter !== 'all') {
                        $viewParams['punctuality'] = $punctuality_filter;
                    }
