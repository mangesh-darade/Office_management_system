    ...
    <form method="post" action="<?php echo site_url('leave/edit/'.(int)$leave->id); ?>">
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <input type="date" class="form-control" name="start_date" value="<?php echo htmlspecialchars($leave->start_date); ?>" required />
        </div>
        <div class="col-md-6">
          <label class="form-label">End Date <span class="text-danger">*</span></label>
          <input type="date" class="form-control" name="end_date" value="<?php echo htmlspecialchars($leave->end_date); ?>" required />
        </div>
        <div class="col-md-6">
          <label class="form-label">Days</label>
          <input type="number" step="0.5" min="0.5" class="form-control" name="days" value="<?php echo htmlspecialchars($leave->days); ?>" />
          <div class="form-text">Enter number of days (e.g., 1, 1.5, 2)</div>
        </div>
        <div class="col-md-12">
          <label class="form-label">Reason</label>
          <textarea class="form-control" name="reason" rows="3"><?php echo htmlspecialchars($leave->reason); ?></textarea>
        </div>
        <div class="col-12">
