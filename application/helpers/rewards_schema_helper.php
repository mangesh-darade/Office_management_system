...
if (!function_exists('rewards_schema_seed_defaults')) {
    ...
    {
        $cats = array(
            array('code' => 'daily', 'name' => 'Daily', 'icon_class' => 'bi bi-sun', 'sort_order' => 1),
        ...
        $rules = array(
            // --- Daily ---
            array('code' => 'office_closing_checklist', 'name' => 'Office Closing Checklist', 'description' => 'Form for submission.', 'trigger_event' => 'office_closing_checklist', 'condition_json' => '{}', 'points' => 30, 'max_per_day' => 1, 'category' => 'daily'),
            array('code' => 'self_work_update_submitted', 'name' => 'Self Work Update Submitted', 'description' => 'Daily Activity submitted.', 'trigger_event' => 'daily_activity_logged', 'condition_json' => '{}', 'points' => 20, 'max_per_day' => 1, 'category' => 'daily'),
            array('code' => 'project_status_update_submitted', 'name' => 'Project Status Update Submitted', 'description' => 'Project status shared.', 'trigger_event' => 'project_status_update', 'condition_json' => '{}', 'points' => 20, 'max_per_day' => 1, 'category' => 'daily'),
            array('code' => 'on_or_before_time', 'name' => 'On or Before Time', 'description' => 'Auto on checkout when check-in was on time.', 'trigger_event' => 'attendance_checkin', 'condition_json' => '{"status":["present","ontime"]}', 'points' => 10, 'max_per_day' => 1, 'category' => 'daily'),
            array('code' => 'on_or_before_time_penalty', 'name' => 'On or Before Time — Deallocate', 'description' => 'Auto on checkout when check-in not found.', 'trigger_event' => 'attendance_penalty', 'condition_json' => '{"penalty_type":"missed_checkin"}', 'points' => -20, 'max_per_day' => 1, 'category' => 'daily'),
            array('code' => 'checkout_submitted', 'name' => 'Checkout Submitted', 'description' => 'Auto when checkout is recorded.', 'trigger_event' => 'attendance_checkout', 'condition_json' => '{}', 'points' => 10, 'max_per_day' => 1, 'category' => 'daily'),
            array('code' => 'checkout_missed_penalty', 'name' => 'Checkout Submitted — Deallocate', 'description' => 'Auto on next check-in when previous day checkout was missing.', 'trigger_event' => 'attendance_penalty', 'condition_json' => '{"penalty_type":"missed_checkout"}', 'points' => -20, 'max_per_day' => 1, 'category' => 'daily'),
            array('code' => 'preapproved_leave_wfh', 'name' => 'Preapproved Leaves or WFHs', 'description' => 'To be submitted by Lead.', 'trigger_event' => 'reward_claim', 'condition_json' => $claim('preapproved_leave_wfh'), 'points' => 50, 'requires_approval' => 1, 'approval_role' => 'lead', 'category' => 'daily'),
            array('code' => 'preapproved_leave_wfh_penalty', 'name' => 'Preapproved Leaves or WFHs — Deallocate', 'description' => 'Lead deallocation for policy breach.', 'trigger_event' => 'reward_claim', 'condition_json' => $claim('preapproved_leave_wfh_penalty'), 'points' => -200, 'requires_approval' => 1, 'approval_role' => 'lead', 'category' => 'daily'),
            array('code' => 'timely_wfh_late_intimation', 'name' => 'Timely Intimation of WFH or Late Coming', 'description' => 'To be submitted by Lead.', 'trigger_event' => 'reward_claim', 'condition_json' => $claim('timely_wfh_late_intimation'), 'points' => 50, 'requires_approval' => 1, 'approval_role' => 'lead', 'category' => 'daily'),
            array('code' => 'timely_wfh_late_intimation_penalty', 'name' => 'Timely Intimation — Deallocate', 'description' => 'Lead deallocation when intimation was not timely.', 'trigger_event' => 'reward_claim', 'condition_json' => $claim('timely_wfh_late_intimation_penalty'), 'points' => -200, 'requires_approval' => 1, 'approval_role' => 'lead', 'category' => 'daily'),

            // --- Learning ---
            array('code' => 'learning_course_completed', 'name' => 'Learning Course Completed', 'description' => 'Learning course completed.', 'trigger_event' => 'lms_topic_completed', 'condition_json' => '{}', 'points' => 50, 'category' => 'learning'),
            ...
            // --- Team Support ---
            array('code' => 'cheer_submitted', 'name' => 'Submitting Cheers Note', 'description' => 'Cheers form submitted.', 'trigger_event' => 'peer_cheer_sent', 'condition_json' => '{}', 'points' => 25, 'max_per_day' => 5, 'category' => 'team'),
            array('code' => 'cheer_received', 'name' => 'Receiving Cheers Note', 'description' => 'Cheers form submitted by colleague.', 'trigger_event' => 'peer_cheer_received', 'condition_json' => '{}', 'points' => 20, 'max_per_day' => 10, 'category' => 'team'),
            ...
            array('code' => 'self_updates_20_days', 'name' => 'Self Updates 20 Days Continuous', 'description' => 'Auto for monthly review.', 'trigger_event' => 'consistency_review', 'condition_json' => '{"streak_type":"self_updates","days":20}', 'points' => 100, 'max_per_period' => 1, 'period_type' => 'month', 'category' => 'consistency'),
            array('code' => 'ontime_20_days', 'name' => 'On-Time 20 Days Continuous', 'description' => 'Auto for monthly review.', 'trigger_event' => 'consistency_review', 'condition_json' => '{"streak_type":"on_time","days":20}', 'points' => 100, 'max_per_period' => 1, 'period_type' => 'month', 'category' => 'consistency'),
            array('code' => 'no_missed_checkout_month', 'name' => 'No Missed Checkout Entire Month', 'description' => 'Auto for monthly review.', 'trigger_event' => 'consistency_review', 'condition_json' => '{"streak_type":"no_missed_checkout"}', 'points' => 100, 'max_per_period' => 1, 'period_type' => 'month', 'category' => 'consistency'),
