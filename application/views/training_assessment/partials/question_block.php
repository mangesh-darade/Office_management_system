...
?>
<div class="ta-question-body" data-qid="<?php echo (int)$q->id; ?>" data-qtype="<?php echo esc_view($q->question_type); ?>"
  <?php if ($q->question_type === 'coding'): ?>data-code-lang="<?php echo esc_view($q->coding_language); ?>"<?php endif; ?>>
  <p class="lead"><?php echo nl2br(esc_view($q->question_text)); ?></p>
    ...
    <div class="list-group">
      <?php foreach ($opts as $o): ?>
        <label class="list-group-item d-flex gap-2 align-items-center">
          ...
          <span><?php echo esc_view($o->option_text); ?></span>
        </label>
      <?php endforeach; ?>
    </div>
  <?php elseif ($q->question_type === 'text'): ?>
    <textarea class="form-control ta-text-answer" rows="6" placeholder="Your answer"><?php echo esc_view($atext); ?></textarea>
  <?php else: ?>
    <div class="mb-2">
      <span class="badge bg-secondary"><?php echo strtoupper(esc_view($q->coding_language)); ?></span>
    </div>
    <textarea class="form-control font-monospace ta-code-input mb-2" rows="10" spellcheck="false" placeholder="Your code"><?php echo esc_view($code); ?></textarea>
    ...
    <textarea class="form-control font-monospace ta-code-output" rows="4" readonly placeholder="Output appears here"><?php echo esc_view($exout); ?></textarea>
