...
<div class="card shadow-soft"><div class="card-body">
  <h1 class="h4"><?php echo esc_view($item->title); ?></h1>
  <p class="text-muted small"><?php echo esc_view($item->category ?: ''); ?> · <?php echo esc_view($item->status); ?></p>
  <div class="mt-3"><?php echo nl2br(esc_view($item->body)); ?></div>
