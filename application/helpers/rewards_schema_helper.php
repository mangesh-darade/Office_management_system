...
if (!function_exists('rewards_schema_seed_defaults')) {
    function rewards_schema_seed_defaults($db)
    {
        ...
        $rules = array(
            ...
            array('code' => 'attendance_late_checkin', 'name' => 'Late Check-In', 'description' => 'First attendance punch after Grace Period and before 11:00 AM.', 'trigger_event' => 'attendance_checkin', 'condition_json' => '{"attendance_tier":"late"}', 'points' => 0, 'max_per_day' => 1, 'category' => 'daily'),
