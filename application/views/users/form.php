<?php $this->load->view('partials/header', ['title' => ($title ?? 'User'), 'active' => 'users']); ?>
<div class="row g-3">
  <div class="col-12 col-lg-8">
    <div class="d-flex justify-content-between align-items-center mb-2">
      <h5 class="mb-0"><?php echo htmlspecialchars($title ?? 'User'); ?></h5>
