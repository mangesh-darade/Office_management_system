    ...
    <form method="post" action="<?php echo site_url('reminders/bulk'); ?>" class="vstack gap-3">
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="subject" class="form-control" required value="<?php echo esc_view(isset($bulk_subject)?$bulk_subject:''); ?>">
        </div>
        <div class="col-12">
          <label class="form-label">Message</label>
          <textarea name="body" rows="6" class="form-control"><?php echo esc_view(isset($bulk_body)?$bulk_body:''); ?></textarea>
