...
<div class="mb-3"><label class="form-label">Title</label><input name="title" class="form-control" value="<?php echo $row ? esc_view($row->title) : 'Review Session'; ?>"></div>
...
<div class="mb-3"><label class="form-label">Meeting link</label><input name="meeting_link" class="form-control" value="<?php echo $row ? esc_view($row->meeting_link) : ''; ?>"></div>
<div class="mb-3"><label class="form-label">Notes (client visible)</label><textarea name="notes_client" class="form-control" rows="2"><?php echo $row ? esc_view($row->notes_client) : ''; ?></textarea></div>
<div class="mb-3"><label class="form-label">Internal notes</label><textarea name="notes_internal" class="form-control" rows="2"><?php echo $row ? esc_view($row->notes_internal) : ''; ?></textarea></div>
<div class="mb-3"><label class="form-label">Homework summary</label><textarea name="homework_summary" class="form-control" rows="2"><?php echo $row ? esc_view($row->homework_summary) : ''; ?></textarea></div>
