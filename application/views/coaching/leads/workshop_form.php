...
<input name="title" class="form-control mb-2" required placeholder="Title" value="<?php echo $row?htmlspecialchars($row->title):''; ?>">
<textarea name="description" class="form-control mb-2" rows="3"><?php echo $row?htmlspecialchars($row->description):''; ?></textarea>
...
<input name="location" class="form-control mb-2" placeholder="Location" value="<?php echo $row?htmlspecialchars($row->location):''; ?>">
