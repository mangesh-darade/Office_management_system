...
<tr><td><?php echo htmlspecialchars($r->ticket_number); ?></td><td><?php echo htmlspecialchars($r->subject); ?></td><td><?php echo htmlspecialchars($r->priority); ?></td><td><?php echo htmlspecialchars($r->status); ?></td><td><?php echo htmlspecialchars($r->requester_name); ?></td><td><a class="btn btn-sm btn-outline-primary" href="<?php echo site_url('helpdesk/edit/'.$r->id); ?>">Open</a></td></tr>
